...
Tính năng:
1. Tự động cache embedding theo SHA256 để tiết kiệm chi phí và tăng tốc chạy
2. Chấm 2 mức: Mức 1 (Document match) và Mức 2 (Content keyword match)
3. Thực nghiệm A/B testing bắt buộc trên câu hỏi lọc metadata
4. Phân tích ca thành công / thất bại
5. Tự động xuất báo cáo ra file ket_qua_benchmark.txt
"""
